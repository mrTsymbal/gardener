...
if (is_admin()) {
    ...
    function ale_inject_archives_menu_meta_box() {
        add_meta_box('ale-nav-advanced', esc_html__( 'Advanced Navigation', 'olins' ), 'ale_wp_nav_menu_archives_meta_box', 'nav-menus', 'side', 'default');
    }
    ...
    function ale_wp_nav_menu_archives_meta_box() {
        ...
        foreach (
            ...
            $post_type->title = $post_type->labels->name . ' ' . esc_html__('Archive', 'olins');
        ...
        <p class="button-controls">
				<span class="add-to-menu">
					...
					<input type="submit" class="button-secondary submit-add-to-menu" value="<?php esc_html_e('Add to Menu','olins'); ?>" name="add-ctp-archive-menu-item" id="submit-ale-archive" />
				</span>
        </p>
    <?php
    }
