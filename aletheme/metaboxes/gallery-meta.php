...
function add_gallery_metabox($post_type) {
	...
	if (in_array($post_type, $types)) {
		add_meta_box(
			'gallery-metabox',
			esc_html__('Gallery Images','olins'),
...
function gallery_meta_callback($post) {
	...
	<table class="form-table">
		<tr><td>
				<a class="gallery-add button" href="#" data-uploader-title="<?php echo esc_html_e('Add image(s) to gallery','olins'); ?>" data-uploader-button-text="<?php echo esc_html_e('Add image(s)','olins'); ?>"><i class="fa fa-picture-o" aria-hidden="true"></i> <?php echo esc_html_e('Add image(s)','olins'); ?></a>
					...
					<?php if ($ids) : foreach ($ids as $key => $value) : $image = wp_get_attachment_image_src($value); ?>
						...
						<li class="image_holder">
							...
							<div class="buttons_manage">
								<a class="change-image button button-primary button-medium" href="#" data-uploader-title="<?php echo esc_html_e('Change image','olins'); ?>" data-uploader-button-text="Change image"><i class="fa fa-pencil" aria-hidden="true"></i></a>
