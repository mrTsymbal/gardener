...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__('No Repeat', 'olins'),
		'repeat-x'  => esc_html__('Repeat Horizontally', 'olins'),
		'repeat-y'  => esc_html__('Repeat Vertically', 'olins'),
		'repeat'    => esc_html__('Repeat All', 'olins'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__('Top Left', 'olins'),
		'top center'    => esc_html__('Top Center', 'olins'),
		'top right'     => esc_html__('Top Right', 'olins'),
		'center left'   => esc_html__('Middle Left', 'olins'),
		'center center' => esc_html__('Middle Center', 'olins'),
		'center right'  => esc_html__('Middle Right', 'olins'),
		'bottom left'   => esc_html__('Bottom Left', 'olins'),
		'bottom center' => esc_html__('Bottom Center', 'olins'),
		'bottom right'  => esc_html__('Bottom Right', 'olins')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__('Scroll Normally', 'olins'),
		'fixed'  => esc_html__('Fixed in Place', 'olins')
		);
...
function of_recognized_background_size() {
	$default = array(
		'auto' => esc_html__('Auto', 'olins'),
		'cover'  => esc_html__('Cover', 'olins'),
		'contain'  => esc_html__('Contain', 'olins'),
		'initial'  => esc_html__('Initial', 'olins'),
...
function of_recognized_menu_text_align() {
	$default = array(
		'left' => esc_html__('Left', 'olins'),
		'center'  => esc_html__('Center', 'olins'),
		'right'  => esc_html__('Right', 'olins'),
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__('Normal', 'olins'),
		'italic'      => esc_html__('Italic', 'olins'),
		'bold'        => esc_html__('Bold', 'olins'),
		'bold italic' => esc_html__('Bold Italic', 'olins')
		);
...
function of_recognized_font_transform() {
	$default = array(
		'none'      => esc_html__('None', 'olins'),
		'capitalize'      => esc_html__('Capitalize', 'olins'),
		'uppercase'        => esc_html__('Uppercase', 'olins'),
		'lowercase' => esc_html__('Lowercase', 'olins')
	);
	return apply_filters( 'of_recognized_font_styles', $default );
}
...
function of_recognized_font_weight() {
	$default = array(
		'200' => esc_html__('Extra-Light 200', 'olins'),
		'300' => esc_html__('Light 300', 'olins'),
		'400' => esc_html__('Regular 400', 'olins'),
		'500' => esc_html__('Medium 500', 'olins'),
		'600' => esc_html__('Semi-Bold 600', 'olins'),
		'700' => esc_html__('Bold 700', 'olins'),
		'800' => esc_html__('Extra-Bold 800', 'olins'),
		'900' => esc_html__('Ultra-bold 900', 'olins')
	);
