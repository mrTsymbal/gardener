...
class Aletheme_About_Widget extends WP_Widget 
{
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => esc_html__('A widget that displays a short information about you.', 'olins')
		);
		...
		/* Create the widget. */
		parent::__construct( 'ale_about_widget', esc_html__('Aletheme About Me', 'olins'), $widget_ops, $control_ops );
	}
	...
	public function form( $instance ) 
	{
		...
		$defaults = array(
			'title'		=> esc_html__('About Me', 'olins'),
			'text'		=> "",
			'image'		=> "",
		);
