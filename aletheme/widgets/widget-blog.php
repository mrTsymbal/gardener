...
class Aletheme_Blog_Widget extends WP_Widget 
{
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => esc_html__('A widget that displays your latest posts with image.', 'olins')
		);
		...
		/* Create the widget. */
		parent::__construct( 'ale_blog_widget', esc_html__('Aletheme Recent Posts', 'olins'), $widget_ops, $control_ops );
	}
	...
	public function form( $instance ) 
	{
		...
		$defaults = array(
			'title' => esc_html__('Latest Blog Posts', 'olins'),
			'number' => 4
		);
		$instance = wp_parse_args( (array) $instance, $defaults ); ?>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e('Title:', 'olins') ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php esc_html_e('Posts to show:', 'olins') ?></label>
